...
namespace TeleSharp.TL
{
    ...
    public class TLConfig : TLAbsConfig
    {
     ...
     public TLVector<TLAbsDisabledFeature> disabled_features {get;set;}
...
disabled_features = (TLVector<TLAbsDisabledFeature>)ObjectUtils.DeserializeVector<TLAbsDisabledFeature>(br);
Type = TLAbsConfigTypes.TLConfig;
        }
